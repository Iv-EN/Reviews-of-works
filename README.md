### Reviews-of-works (групповой проект).
### Описание
Проект Reviews-of-works собирает отзывы пользователей на произведения.
...
Сами произведения в Reviews-of-works не хранятся, здесь нельзя посмотреть фильм или послушать музыку.
...
# Описание и установка проекта Reviews-of-works
...
Я занимался разработкой кастомных моделей отзывов, категорий и жанров, а так же реализовал функционал загрузки данных из `csv` файлов в базу данных 
